		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "XML Fattura Elettronica con Stylesheet",
									"targetURL": "#ui5demoxmlwithstylesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5demoxmlwithstylesheet-display": {
								"semanticObject": "ui5demoxmlwithstylesheet",
								"action": "display",
								"description": "XML Fattura Elettronica con Stylesheet",
								"title": "XML Fattura Elettronica con Stylesheet",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.demo.xmlwithstylesheet",
									"url": sap.ui.require.toUrl("ui5/demo/xmlwithstylesheet")
								}
							}
						}
					}
